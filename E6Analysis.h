...
// Mon Mar  7 02:16:49 2022 by ROOT version 6.24/06
// from TTree LHEF/Analysis tree
// found on file: E6isosinglet.root
//////////////////////////////////////////////////////////
...
#ifdef E6Analysis_cxx
E6Analysis::E6Analysis(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("E6isosinglet.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("E6isosinglet.root");
      }
...
E6Analysis::~E6Analysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t E6Analysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t E6Analysis::LoadTree(Long64_t entry)
{
...
void E6Analysis::Init(TTree *tree)
{
...
void E6Analysis::Show(Long64_t entry)
{
...
Int_t E6Analysis::Cut(Long64_t entry)
{
